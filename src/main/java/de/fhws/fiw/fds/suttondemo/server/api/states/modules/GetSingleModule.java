...
public class GetSingleModule extends AbstractGetState<Response, Module> {
    ...
    protected void defineTransitionLinks() {
        addLink(ModuleUri.REL_PATH_ID, ModuleRelTypes.UPDATE_SINGLE_MODULE + "_" + System.nanoTime(), getAcceptRequestHeader(), this.requestedId);
        addLink(ModuleUri.REL_PATH_ID, ModuleRelTypes.DELETE_SINGLE_MODULE + "_" + System.nanoTime(), getAcceptRequestHeader(), this.requestedId);
    }
}
